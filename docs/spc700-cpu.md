...
- [Running instructions](#running-instructions)
  - [One cycle at a time](#one-cycle-at-a-time)
  - [Halting](#halting)
- [The cycle bar](#the-cycle-bar)
- [The moves](#the-moves)
  - [Where the cycles go](#where-the-cycles-go)
  - [The store that reads nothing](#the-store-that-reads-nothing)
  - [Where an indirect mode spends its cycle](#where-an-indirect-mode-spends-its-cycle)
  - [The two-operand moves](#the-two-operand-moves)
- [The arithmetic](#the-arithmetic)
  - [The comparison that writes nothing](#the-comparison-that-writes-nothing)
  - [Where the cycles go](#where-the-cycles-go-1)
- [The words and the bits](#the-words-and-the-bits)
  - [A word is two direct-page bytes](#a-word-is-two-direct-page-bytes)
  - [One bit at a time](#one-bit-at-a-time)
  - [Multiply, divide, and the decimal adjusts](#multiply-divide-and-the-decimal-adjusts)
- [The control flow](#the-control-flow)
  - [The branches](#the-branches)
  - [The jumps](#the-jumps)
  - [The calls and the returns](#the-calls-and-the-returns)
  - [The stack transfers](#the-stack-transfers)
  - [The flag operations and the halts](#the-flag-operations-and-the-halts)
