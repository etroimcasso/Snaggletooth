...
| Read a tree's program file, whole or one source file's regions at a time | [ir.md §Reading a program](ir.md#reading-a-program), [snagir.md](snagir.md) |
