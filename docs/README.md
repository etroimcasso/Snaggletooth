...
says so in place rather than leaving the reader to infer it — the PPU, for instance, draws four of
the eight modes and not yet the other four, and [ppu.md](ppu.md) says which is which where it
