...
// leaves it in place — the bus observer's terms exactly. The PPU resolves pixels
// only while one is set; with none, a machine keeps its registers and memories as
// it always does and draws nothing.
